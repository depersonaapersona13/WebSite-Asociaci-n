...
(function () {
  ...
  var TEXTOS = { es: {
      comun: {
        ...
        temaClaro: "Enable dark mode",
        temaOscuro: "Disable dark mode",
        cambiarIdioma: "Change language",
        cargando: "Loading…",
        pendiente: "Information pending completion.",
        imagenPendiente: "Image pending",
        masInfo: "More information",
        enMarcha: "In progress",
        ...
        sinResultados: "No projects found with this filter yet.",
        pendienteProyectos: "Projects pending publication.",
        pendienteContacto: "Contact details pending confirmation.",
        pendienteLegal: "Legal information pending publication.",
        pendienteJunta: "Team composition pending publication.",
        pendienteRedes: "Social networks pending addition.",
        pendienteTestimonios: "Testimonials pending publication.",
        pendienteFila: "Pending completion.",
        pendienteTestimonio: "Testimonial pending publication."
      },
      nav: {
        inicio: "Inicio",
    ...
    en: {
      ...
      legal: {
        ...
        titulo: "Legal Notice",
        intro: "In compliance with article 10 of Law 34/2002, of\n11 July, on Information Society Services and Electronic\nCommerce (LSSI-CE), users are informed of the identifying data\nand the conditions of use of the website.",
      ...
      privacidad: {
        ...
        intro: "At the De Personas a Personas Youth Association\nwe take your privacy very seriously. We explain transparently\nhow we process your personal data.",
